...
{
    /// <summary>
    /// 	Initialises a new instance of the <see cref="HarmonyServerPatchAttribute"/> class.
    /// </summary>
    ...
    public HarmonyServerPatchAttribute(string typeName, string methodName, MethodType methodType = MethodType.Normal) : base(EnumAppSide.Server, typeName, methodName, methodType)
    {
    }
    ...
    public HarmonyServerPatchAttribute(string declaringType, string methodName, params Type[] arguments) : base(EnumAppSide.Server, declaringType, methodName, arguments)
    {
    }
}