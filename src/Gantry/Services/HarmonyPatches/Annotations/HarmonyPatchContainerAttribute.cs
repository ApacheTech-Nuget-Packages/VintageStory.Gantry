...
public class HarmonyPatchContainerAttribute : Attribute, IConditionalOnSide
{
    /// <summary>
    ///     Initialises a new instance of the <see cref="HarmonyPatchContainerAttribute"/> class for the specified application side.
    /// </summary>
    /// <param name="side">The application side to which the attribute applies. The default is EnumAppSide.Universal.</param>
    public HarmonyPatchContainerAttribute(EnumAppSide side = EnumAppSide.Universal) => Side = side;
