...
public static class FileInfoExtensions
{
    ...
    {
        await using var sourceStream = new FileStream(fileInfo.FullName, FileMode.Append, FileAccess.Write, FileShare.None, DEFAULT_BUFFER_SIZE, true);
    ...
    public static async Task<IEnumerable<string>> ReadAllLinesAsync(this FileInfo fileInfo)
    {
        ...
        await using var sourceStream = new FileStream(fileInfo.FullName, FileMode.Open, FileAccess.Read, FileShare.Read, DEFAULT_BUFFER_SIZE, DEFAULT_FILE_OPTIONS);
