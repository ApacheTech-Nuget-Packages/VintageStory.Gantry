...
public static class NetworkChannelExtensions
{
    ...
    /// </returns>
    public static IClientNetworkChannel RegisterPacket<T>(this IClientNetworkChannel channel, ICoreGantryAPI gapi, NetworkServerMessageHandler<T>? handler = null)
    {
