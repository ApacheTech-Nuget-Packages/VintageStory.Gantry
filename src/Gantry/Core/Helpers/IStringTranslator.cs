...
{
    /// <summary>
    ///     The default domain for the mod, typically the mod ID.
    /// </summary>
    ...
    /// <param name="args">Arguments for formatting.</param>
    /// <returns>The localised string from the current mod domain.</returns>
    string Get(string path, params object[] args)
        => Lang.Get($"{DefaultDomain}:{path}", args);
    ...
    string GetD(string domain, string path)
    ...
    /// <param name="args">Arguments for formatting.</param>
    /// <returns>The localised string from the specified domain.</returns>
    string GetD(string domain, string path, params object[] args)
    ...
    /// <param name="args">Arguments for formatting.</param>
    /// <returns>The localised string from the gantry domain.</returns>
    string Gantry(string path, params object[] args)
    ...
    string PlayerLanguage(IPlayer player)
