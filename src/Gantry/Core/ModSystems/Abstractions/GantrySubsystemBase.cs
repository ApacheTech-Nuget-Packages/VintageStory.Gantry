...
/// </summary>
public abstract class GantrySubsystemBase : IDisposable
{
    /// <summary>
    ...
    /// <summary>
    ///     Whether to load the subsystem or not.
    /// </summary>
    ...
    ///     Called during the initial mod loading phase, before any mod receives the <see cref="Start" /> call.
    /// </summary>
    public virtual void StartPreUniversal(ICoreAPI api) 
    {
    }
    ...
    ///     Called during the initial mod loading phase, before any mod receives the <see cref="Start" /> call.
    /// </summary>
    /// <param name="capi">The API interface for the core game.</param>
    ...
    ///     Called during the initial mod loading phase, before any mod receives the <see cref="Start" /> call.
    /// </summary>
    /// <param name="sapi">The API interface for the core game.</param>
    ...
    public virtual void ConfigureUniversalModServices(IServiceCollection services, ICoreAPI api)
    {
    }

    /// <inheritdoc cref="IServerServiceRegistrar.ConfigureServerModServices(IServiceCollection, ICoreServerAPI)" />
    public virtual void ConfigureServerModServices(IServiceCollection services, ICoreServerAPI sapi)
    {
    }

    /// <inheritdoc cref="IClientServiceRegistrar.ConfigureClientModServices(IServiceCollection, ICoreClientAPI)" />
    public virtual void ConfigureClientModServices(IServiceCollection services, ICoreClientAPI capi)
    {
    }
}