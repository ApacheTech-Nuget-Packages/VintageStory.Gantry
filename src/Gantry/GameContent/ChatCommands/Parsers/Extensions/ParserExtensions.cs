namespace Gantry.GameContent.ChatCommands.Parsers.Extensions;
...
public static class ParserExtensions
{
    ...
    /// </summary>
    public static GantryPlayersArgParser ServerPlayers(this CommandArgumentParsers _, ICoreAPI api)
        => new("players", api, true);
    ...
    /// </summary>
    public static GantryPlayersArgParser OptionalServerPlayers(this CommandArgumentParsers _, ICoreAPI api)
        => new("players", api, false);

    /// <summary>
    ///     Parses a string as an online player, returning an array of <see cref="PlayerUidName"/>, allowing partial matches. (Universal)
    /// </summary>
    public static GantryOnlinePlayersArgParser ClientPlayer(this CommandArgumentParsers _, ICoreAPI api)
        => new("players", api, true);
    ...
    /// </summary>
    public static GantryOnlinePlayersArgParser OptionalClientPlayer(this CommandArgumentParsers _, ICoreAPI api)
        => new("players", api, false);
}