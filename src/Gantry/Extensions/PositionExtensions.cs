using Gantry.Extensions.Helpers;
...
public static class PositionExtensions
{
    ...
    {
        return pos.SubCopy(world.DefaultSpawnPosition.XYZ.AsBlockPos).With(p => p.Y = pos.Y);
    }
    ...
    public static BlockPos ToAbsolute(this BlockPos pos, IWorldAccessor world, BlockPos? spawnPosition = null)
    {
        spawnPosition ??= world.DefaultSpawnPosition.XYZ.AsBlockPos;
    ...
    /// <param name="pos">The absolute position of the block being queried.</param>
    /// <param name="world">The world accessor to use to get the default spawn position.</param>
    public static Vec3d RelativeToSpawn(this Vec3d pos, IWorldAccessor world)
    {
        return pos.SubCopy(world.DefaultSpawnPosition.XYZ).With(p => p.Y = pos.Y);
    }
    ...
    /// <param name="world">The world accessor to use to get the default spawn position.</param>
    /// <param name="spawnPosition">The spawn position to use as the relative origin.</param>
    public static Vec3d ToAbsolute(this Vec3d pos, IWorldAccessor world, Vec3d? spawnPosition = null)
    {
        spawnPosition ??= world.DefaultSpawnPosition.XYZ;
