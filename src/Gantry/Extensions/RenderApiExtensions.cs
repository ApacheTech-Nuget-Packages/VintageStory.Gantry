...
public static class RenderApiExtensions
{
    ...
    /// </summary>
    public static void ReloadShadersThreadSafe(this ICoreClientAPI capi, ICoreGantryAPI core)
    {
    ...
    /// </returns>
    public static MeshRef Get2dLineMesh(this IRenderAPI api, ICoreGantryAPI core, Waypoint startPoint, Waypoint endPoint)
    {
        ...
        var mapManager = core.Services.GetRequiredService<WorldMapManager>();
