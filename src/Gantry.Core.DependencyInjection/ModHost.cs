...
namespace Gantry.Core.DependencyInjection
{
    ...
    public abstract class ModHost : UniversalModSystem
    {
        ...
        protected virtual void ConfigureUniversalModServices(IServiceCollection services) { }
        ...
        private void BuildServerHost(ICoreServerAPI sapi)
        {
            ...
            _services.With(ServerApiRegistrar.RegisterServerApiEndpoints);
            ...
            _services
                .With(ConfigureUniversalModServices)
                .With(ConfigureServerModServices);

            //  4. Register all features that need registering. 
            _universalServiceRegistrars.ForEach(x => x.ConfigureUniversalModServices(_services));
            _serverServiceRegistrars.ForEach(x => x.ConfigureServerModServices(_services));
        ...
        {
            //  1. Configure game API services.
            _services.With(ClientApiRegistrar.RegisterClientApiEndpoints);
            ...
            _services
                .With(ConfigureUniversalModServices)
                .With(ConfigureClientModServices);

            //  4. Register all features that need registering. 
            _universalServiceRegistrars.ForEach(x => x.ConfigureUniversalModServices(_services));
            _clientServiceRegistrars.ForEach(x => x.ConfigureClientModServices(_services));
